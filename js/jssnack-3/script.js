...
const listOfNumbers = [21, 4, 5, 7, 98, 89, 6, 32]; // Scriviamo un array con una lista di numeri casuali
...
for (let i = 0; i < listOfNumbers.length; i++) {
    const evenAndOdd = listOfNumbers[i];

    const addList = document.createElement('li');
    addList.innerHTML = evenAndOdd;
    if (evenAndOdd % 2 === 0) { // Verifichiamo quale numero, scorrendo l'intera lista, è pari e quale è dispari
